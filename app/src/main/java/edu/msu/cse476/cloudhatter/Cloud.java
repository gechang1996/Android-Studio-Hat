...
public class Cloud {
    ...
    private static final String USER = "gechang1";
    private static final String PASSWORD = "qwerasdf";
    private static final String CATALOG_URL = "http://webdev.cse.msu.edu/~gechang1/cse476/step6/hatter-cat.php";
    private static final String SAVE_URL = "http://webdev.cse.msu.edu/~gechang1/cse476/step6/hatter-save.php";
...
//    private static final String SAVE_URL = "https://facweb.cse.msu.edu/dennisp/cse476x/hatter-save.php";
    private static final String DELETE_URL = "http://webdev.cse.msu.edu/~gechang1/cse476/step6/hatter-delete.php";
//    private static final String LOAD_URL = "http://facweb.cse.msu.edu/dennisp/cse476x/hatter-load.php";
    private static final String LOAD_URL = "http://webdev.cse.msu.edu/~gechang1/cse476/step6/hatter-load.php";
